...
export const metadata: Metadata = {
  title: "Terms of Use — NO-DISH",
  description: "Terms of use for NO-DISH — Media without the dish.",
};
      ...
      <div className="mx-auto max-w-3xl px-5 py-12 sm:px-8 sm:py-16">
        ...
        <div className="mt-10 space-y-10 text-sm leading-7 text-muted-foreground">
          ...
          <section>
            ...
            <p className="mt-3">
              NO-DISH currently operates without paid subscriptions and
          ...
          <section>
            ...
            <p className="mt-3">
              NO-DISH does not claim ownership of movies, books, television
              streams, artwork, metadata, trademarks, or other material
              belonging to third parties.
            </p>
            <p className="mt-3">
              NO-DISH acts as an interface and discovery layer over external
          ...
          <section>
            ...
            <p className="mt-3">
              You are responsible for using NO-DISH and any linked external
          ...
          <section>
            ...
            <p className="mt-3">
              NO-DISH may use or link to services including Internet Archive,
              Project Gutenberg, Gutendex, iptv-org, and third-party stream
              providers. Those services operate independently from NO-DISH and
              may have their own terms, licenses, privacy policies, and
              restrictions.
            </p>
            <p className="mt-3">
              NO-DISH cannot guarantee that an external service, stream,
          ...
          <section>
            ...
            <p className="mt-3">
              NO-DISH respects copyright, trademarks, licenses, and other
              intellectual-property rights. Source attribution is provided
              where appropriate, and NO-DISH does not intend to represent
              third-party material as its own.
            </p>
            <p className="mt-3">
              If you believe material presented through NO-DISH infringes your
          ...
          <section>
            ...
            <p className="mt-3">
              NO-DISH is provided on an as-available basis. External APIs,
          ...
          <section>
            ...
            <p className="mt-3">
              By using NO-DISH, you acknowledge that it is an independent,
          ...
          <section className="border-t border-border/60 pt-8">
            <p>
              These terms are intended to describe how NO-DISH operates. They
