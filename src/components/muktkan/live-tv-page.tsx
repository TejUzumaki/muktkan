      ...
      <div className="relative px-4 pb-8 pt-8 sm:px-8 sm:pb-10 sm:pt-10">
        <div className="mb-5 flex items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-2 max-w-xl text-sm leading-6 text-white/45">
              ...
              zoom, pan, and select any signal to watch.
            </p>
          </div>
        ...
        {channels.length > points.length && (
          <p className="mt-5 text-center text-[11px] text-white/25">
            ...
            {channels.length - points.length} remain in the
            catalogue and can be surfaced through category
            spaces.
          </p>
        )}
      </div>
